...
public class CollectController {
    ...
    public ResponseEntity<CollectResponseDTO> createCollect(@RequestBody CollectCreateDTO collectCreateDTO) {
        CollectResponseDTO collectResponseDTO = collectService.createCollectAndAddress(collectCreateDTO);
